...
One line per doc surface: what it is authoritative for. If two docs disagree, the one
named here wins; fix the other. **Every phase ends by reconciling these to reality
("leave the docs true").**
